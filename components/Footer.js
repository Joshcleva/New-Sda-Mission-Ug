...
const Footer = () => {
    ...
    <div className="mt-16">
      <footer
        className="bg-absolute backdrop-blur w-full "
        style={{
          backgroundImage:
        ...
        <div className="py-12 spacing flex flex-col md:flex-row md:justify-between text-center">
          ...
          <section className=" grid md:grid-cols-3 md:gap-4 lg:gap-12 justify-items-center desktop:gap-24">
            ...
            <div className="text-light-grayish-blue mb-4 md:mb-0 md:text-left font-semibold cursor-pointer">
              <ul className="grid gap-y-3">
                ...
                <li>
                  <Link href="/DonateUs">
                    <a className="footer-link">Donate to Us</a>
                  </Link>
                </li>
              </ul>
            </div>
              ...
              <ul className="grid gap-y-3 md:text-left">
                <li>
                  <Link href="/Upload-Music">
                    <a className="footer-link">UpLoad Your Music</a>
                  </Link>
                </li>
                <li>
          ...
          <section className="md:text-right font-semibold cursor-pointer">
            ...
            <p className="text-sm text-grayish-blue mt-8 font-semibold cursor-pointer">
              © SdaMission 2022. All Rights Reserved
            </p>
          </section>
        </div>
      </footer>
